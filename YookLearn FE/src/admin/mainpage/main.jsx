        ...
        <div className='flex justify-between'>
          <span className='flex items-center'>
            <div className='bg-gray-200 p-4 rounded-t-md'>
              <FontAwesomeIcon icon={faHome} className='text-blue-950 text-3xl pr-3 pb-1' />
              <span className=' mr-4 font-bold text-xl text-blue-950'>Home</span>
            </div>
          </span>
          <span className='flex items-center'>
            <div className='bg-gray-200 p-2 rounded-md m-2'>
              <a href="">
              <FontAwesomeIcon icon={faBookOpen} className='text-blue-950 text-3xl ml-2' />
              <span className=' ml-2 mr-4 font-bold text-xl text-blue-950'>Daftar Mata Pelajaran</span>
              </a>
            </div>
            <div className='bg-gray-200 p-2 rounded-md'>
              <a href="/list/">
              <FontAwesomeIcon icon={faAddressBook} className='text-blue-950 text-3xl ml-2' />
              <span className=' ml-2 mr-4 font-bold text-xl text-blue-950'>Daftar Akun</span>
              </a>
            </div>
          </span>
        </div>
