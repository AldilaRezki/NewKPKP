...
function pms() {
  ...
  return (
    <div className="bg-white max-h-screen">
      ...
      <h1 className="text-2xl font-bold text-blue-950 mb-4">Daftar Akun Siswa</h1>
        <div className='flex justify-evenly'>
          <div className='flex flex-col w-2/5 items-start justify-center'>
            <div className='border-l-4 border-blue-950 pl-4 my-4'>Isi Data Diri Siswa</div>
            <div className='border-l-4 border-blue-950 pl-4 my-4'>Pilihan Kelas</div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 w-3/5">
            ...
            <button type="submit" className="bg-blue-950 text-white px-4 py-2 rounded-lg">
              <a href="/berhasil/">
                  Simpan
              </a>
            </button>
