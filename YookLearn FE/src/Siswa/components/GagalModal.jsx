...
function GagalModal({ visible, onClose }) {
  const handleOnClose = () => {
    onClose();
  };
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        <div class="bg-[#1A1F5A] px-4 py-3 sm:px-6 sm:flex sm:flex-row">
          <div class="sm:flex-grow">
            <h3 class="text-lg leading-6 font-medium text-white">Gagal!</h3>
          </div>
        ...
        <div class="px-4 py-3 sm:p-6">
          <p class="text-gray-700">Password Gagal diubah. </p>
        </div>
