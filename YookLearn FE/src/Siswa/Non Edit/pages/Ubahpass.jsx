...
import ModalUbahPass from '../components/ModalUbahPass';

function Ubahpass() {
  const [showModalUbahPass, setShowModalUbahPass] = useState(false);

  const handleOnClose = () => setShowModalUbahPass(false);
  return (
    <>
      <div>
        <Header />
      ...
      <div className='flex justify-center items-center h-screen'>
        <form className='bg-white p-6 rounded-lg shadow-lg'>
          ...
          <button
            onClick={() => setShowModalUbahPass(true)}
      ...
      <ModalUbahPass onClose={handleOnClose} visible={showModalUbahPass} />
    </>
  );
}
