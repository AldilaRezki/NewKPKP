      ...
      <div className='flex justify-between'>
        <div className='flex mt-16 ml-10 flex-col gap-y-8 w-3/5'>
          <div className='homepage_Card text-xl flex bg-tosca p-4 rounded-lg shadow-md'>
            <h1>Selamat Pagi, Lorem! Terdapat 3 Kelas untuk diajar hari ini.</h1>
          </div>
          ...
          <div className='buttonKelas bg-tosca mb-20'>
            <a href='/daftarkelas' className='flex text-2xl bg-white my-7 py-5 px-20 shadow-md justify-center item-center m-auto mx-5'>
              Lihat Daftar Kelas
            </a>
          </div>
        </div>
