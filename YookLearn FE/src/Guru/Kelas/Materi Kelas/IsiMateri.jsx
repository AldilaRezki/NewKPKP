  ...
  return (
    <div>
      ...
      <div className='flex ml-10 mt-10 gap-x-5'>
        <BiBook className='bg-tosca
        text-biru text-5xl rounded-full p-2'></BiBook>
        <span className='text-biru text-xl my-auto font-medium'>Materi Pekan 1</span>
      </div>

      <div className='flex ml-[110px] mt-10 gap-x-5 text-biru'>
        <span className='bg-tosca p-3 rounded-lg'>Bahan Ajar Pertemuan 1.pdf</span>
