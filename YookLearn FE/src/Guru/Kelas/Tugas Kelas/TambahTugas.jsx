...
function TambahTugas() {
  return (
    <div>
        ...
        <div>
            <h2 className='text-md mt-8 ml-10 font-normal text-biru'>Judul Tugas</h2>
            <form>
        ...
        <div className='flex ml-10 gap-x-9'>
            <div>
                ...
                <div className='flex gap-x-8'>
                    <form action="">
                        <input type="date" name="" id="" className='mt-4 py-2 px-5 border-[0.3px] shadow-md'/>
                    </form>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='flex gap-x-8'>
                    <form action="">
                        <input type="time" name="" id="" className='mt-4 py-2 px-5 border-[0.3px] shadow-md' />
                    </form>
                </div>   
            </div>
            ...
            <div>
                <h2 className='text-md mt-8 font-normal text-biru'>Setelah melewati tenggat waktu</h2>
                <div className='flex'>
