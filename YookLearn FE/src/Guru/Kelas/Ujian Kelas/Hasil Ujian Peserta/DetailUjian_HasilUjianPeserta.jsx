      ...
      <div className='flex pl-3 pt-5 pb-8 gap-x-60'>
        <div className='flex flex-col gap-y-3'>
          <div className='flex gap-x-10'>
            ...
            <span className='bg-white border-[0.3px] py-1.5 pl-4 w-[331px] shadow-md'>Bahasa Indonesia</span>
          </div>
          <div className='flex gap-x-[3.7rem]'>
            <span className='mt-2'>Jumlah Soal:</span>
            <span className='bg-white border-[0.3px] py-1.5 pl-4 w-[331px] shadow-md'>10 Nomor</span>
          </div>  
        </div>
        ...
        <div className='flex flex-col gap-y-3'>
          <div className='flex gap-x-[3.1rem]'>
            ...
            <span className='bg-white border-[0.3px] py-1.5 pl-4 w-[331px] shadow-md'>60 Menit</span>
          </div>
          <div className='flex gap-x-10'>
            <span className='mt-2'>Tanggal Ujian:</span>
            <span className='bg-white border-[0.3px] py-1.5 pl-4 w-[331px] shadow-md'>10 Maret 2023</span>
          </div>  
        </div>
