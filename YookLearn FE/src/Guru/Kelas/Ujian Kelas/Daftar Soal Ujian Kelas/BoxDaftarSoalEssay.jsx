        ...
        <div className="atasSoalEssay flex justify-between">
            <div className="pertanyaanSoalEssay flex flex-col w-2/3 gap-y-2">
                ...
                <span className='bg-white border-[0.3px]  p-5 shadow-md'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed varius euismod nulla ut fermentum. Nunc ut risus auctor, iaculis nisi euismod, faucibus sapien. Cras fringilla rutrum nisi id gravida. Ut nec felis nec lacus blandit dapibus in quis dui.
                </span>
            </div>
            <div className="detailSoalEssay flex flex-col mr-28 gap-y-6">
                ...
                <div className="poinSoalEssay flex flex-col">
                    <span>Poin Soal</span>
                    <span className='bg-white border-[0.3px] py-2 pl-3 shadow-md'>5</span>
                </div>
            </div>
        </div>
        <div className="pilihanSoalEssay">
            <span>Jawaban</span>
            <div className='bg-white flex flex-col gap-y-2 border-[0.3px] my-4 py-3 px-5 shadow-md h-[275px]'>
            </div>
