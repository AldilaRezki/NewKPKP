...
export async function addMateri(idMapel, judul, file) {
    try {
        ...
        const response = await fetch(
            `${BASE_URL}/matpel/${idMapel}/materi/add`,
            {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`,
...
export async function addUjian(
    ...
    try {
        ...
        const response = await fetch(
            `${BASE_URL}/matpel/${idMapel}/ujian/add`,
            {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`,
...
export async function addSoal(idUjian, listSoal) {
    try {
        ...
        const response = await fetch(
            `${BASE_URL}/ujian/${idUjian}/tambahSoal`,
            {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`,
...
export async function addTugas(
    ...
    try {
        ...
        const response = await fetch(
            `${BASE_URL}/matpel/${idMapel}/tugas/add`,
            {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`,
...
export async function showLogbook(id = "") {
    try {
        const token = localStorage.getItem("token");
        const response = await fetch(`${BASE_URL}/logbook/${id}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        });
